...
public class GamePanel extends JPanel implements Runnable {
    ...
    updatesPerSecond = 500, //Amount of logical updates per second
    volume = 50;
    ...
    Action spacePressedAction = keyH.new SpacePressedAction();
    Action spaceReleasedAction = keyH.new SpaceReleasedAction();
    ...
    public void updateKeyBindings() {
        ...
        thisWindow.getInputMap().put(KeyStroke.getKeyStroke("SPACE"), "spacePressed");
		thisWindow.getActionMap().put("spacePressed", spacePressedAction);
        thisWindow.getInputMap().put(KeyStroke.getKeyStroke("released SPACE"), "spaceReleased");
		thisWindow.getActionMap().put("spaceReleased", spaceReleasedAction);
    }
    ...
    public void run() {
        ...
        while (gameThread != null) {
            ...
            if (updateTimer >= 1000000000) {
                System.out.println("TPS: "+updateCount);
                updateCount = 0;
                updateTimer = 0;
            }
        }
